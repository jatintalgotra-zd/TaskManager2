...
func (m *MockService) Create(arg0 *models.Task) (int64, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) Delete(arg0 int64) error {
	m.ctrl.T.Helper()
...
func (m *MockService) GetByID(arg0 int64) (*models.Task, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) Update(arg0 *models.Task) error {
	m.ctrl.T.Helper()
